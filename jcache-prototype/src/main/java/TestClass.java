...
//        cache.registerCacheEntryListener(listenerConfiguration);
    ...
    public void test1() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        URL configUrl = Main.class.getResource("redisson-jcache.yaml");
...
//        System.out.println(cache.get("test1"));
    ...
    @Test
    public void yamlManipulationTest() throws FileNotFoundException {
        InputStream file = new FileInputStream("src/main/resources/gekopair-cache.yaml");
        Yaml yaml = new Yaml();
        Map<String, Object> data = yaml.load(file);

        List<Object> caches = (ArrayList)data.get("cache");

        for(Object o : caches){
            Map<String, Object> cache =  (HashMap<String, Object>)o ;
            if(cache.get("name").equals("WebCache")){
                System.out.println(cache);
            }
        }
