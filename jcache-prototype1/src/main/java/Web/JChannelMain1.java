...
public class JChannelMain1 {

    private static final String CONFIG_PATH = "cluster.xml";

    private static final String CLUSTERNAME = "test";

    protected static Log log = LogFactory.getLog(JChannelMain1.class);

    public static void main(String[] args) throws Exception {
        final URL confPath = JChannelMain1.class.getClassLoader().getResource(CONFIG_PATH);
